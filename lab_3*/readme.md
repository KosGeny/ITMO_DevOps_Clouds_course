...
## Итоговый вариант. Наконец, вот вообще не светим секреты в логах ( обязательно проверяем, что секреты получены, + в примере использование секретов для подключения ДБ и API)
...
#### Риск утечек
- Секреты могут попасть в ненадежные места, такие как слабые CI/CD, логи, ошибки конфигурации, консоль, что может привести к утечкам.
